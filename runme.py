...
command = f'python optimize.py -t {TRANSACTION} -d {DOMAIN} --dexes {DEXES} --reorder \
                    --n_iter 5 --num_samples 5 --parents_portion 0.0 --p_swap_max 0.8 --p_swap_min 0.1 --early_stopping 10\
                    --n_iter_gauss 5 --num_samples_gauss 5 --gauss_random_loguniform --u_random_portion_gauss 0.4 --local_portion 0.3 --cross_portion 0.3 --n_parallel_gauss 1 --capital 10000'
